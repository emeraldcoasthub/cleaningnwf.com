<template>
  <div class="home">
    ...
    <div class="reasons-title columns is-centered">
      <div class="column is-10">
    ...
    <div class="reasons columns is-centered">
      <div v-bind:key="reason" v-for="reason in reasonsLine1" class="column is-3">
        <div class="box">
          ...
          <p class="subtitle is-5 has-text-white">{{ reason.subtitle }}</p>
          <p class="is-size-5 has-text-white">{{ reason.text }}</p>
        </div>
      </div>
    </div>
    <div class="reasons columns is-centered">
    ...
    <div class="reasons columns is-centered">
      ...
      <h2 class="title is-2 has-text-centered">Testimonials</h2>
    <div class="reasons columns is-centered">
      <div class="column is-5">
        <div class="box">
          <h3 class="title is-4 has-text-white">Mondria S.</h3>
          <p class="subtitle is-5 has-text-white">They did an amazing job!!!! I'm very happy.</p>
        </div>
      </div>
      <div class="column is-5">
        <div class="box">
           <h3 class="title is-4 has-text-white">Julie T.</h3>
          <p class="subtitle is-5 has-text-white">Lila did an exceptional job at our home. I really like her and her work performance.</p>
        </div>
      </div>
    </div>
...
.box {
  background-color: #02b397 !important;
}
</style>
